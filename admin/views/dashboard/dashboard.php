...
$sql_total_partner = 'SELECT count(id_partner) FROM table_partner';
$total_partner = mysqli_fetch_row(mysqli_query($connect, $sql_total_partner));
?>
                    ...
                    <div class="col-sm-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h1 class="display-5 mt-1 mb-3"><?= $total_user[0]; ?></h1>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h1 class="display-5 mt-1 mb-3"><?= $total_partner[0]; ?></h1>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h1 class="display-5 mt-1 mb-3">520</h1>
                            </div>
                        </div>
                    </div>
                </div>
