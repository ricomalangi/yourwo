		...
		<nav id="sidebar" class="sidebar">
			...
			<div class="sidebar-content">
				...
				<ul class="sidebar-nav">
					...
					<li class="sidebar-item <?php if($target == 'users' || $target == 'add-user' || $target == 'detail-user' || $target == 'edit-user' || $target == 'partners' || $target == 'add-partner' || $target == 'edit-partner' || $target == 'detail-partner' || $target == 'add-package' || $target == 'edit-package' || $target == 'detail-package' || $target == 'package' || $target == 'testimonials') {echo 'active';} ?>"">
