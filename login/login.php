...
<head>
    ...
    <title>Sign In | Sistem Informasi Akademik</title>
    <!-- Favicon-->
...
$("#menu_login").submit(kirim);
  function kirim(){
    username  = $("#username").val();
    password  = $("#password").val();
    //data = $(this).serializeArray();
    // fileeksekusi,data,output
    $.post("action_login.php",{username:username, password: password},function(output){
      $("#pesan").html(output);
    });
    return false;
  }
