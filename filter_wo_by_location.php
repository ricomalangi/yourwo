...
<div class="page-home">
    <div class="container">
        ...
        <div class="page-best-choices container">
            <div class="row">
                <?php 
                    $sql_partner = "SELECT id_partner, nama_toko, lokasi, picture FROM table_partner WHERE lokasi = '$lokasi'";
                ...
                <?php if($result_partner->num_rows == 0): ?>
                    <h6 class="text-center">Maaf Wedding Organizer belum ada di kota anda</h6>
                <?php endif ?>
            </div>
        </div>
    </div>
