...
$id_partner = encryptId($_SESSION['id_partner']);
?>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="POST" action="<?= $base_url ?>/partner/actions/action_package.php">
                        ...
                        <a href="<?= $base_url ?>/partner/packages" class="btn btn-lg btn-secondary mr-2">Kembali</a>
